                        ...
                        <div class="footer-brand">
                            <div class="footer-logo-container">
                                <div class="footer-logo-wrapper">
                                    <span class="footer-logo-groupe-text">GROUPE</span>
                                    <svg class="footer-logo-svg" width="112" height="50" viewBox="0 0 112 50" fill="none" xmlns="http://www.w3.org/2000/svg">
