/**
 * Loader pour la page Bilan de Compétences
 * Charge les composants modulaires dans la page HTML existante
 */

import { Navbar } from '../components/Navbar.js';
import { Footer } from '../components/Footer.js';
import { BilanCompetencesPage } from '../pages/BilanCompetencesPage.js';

// Initialiser la page
async function initBilanPage() {
    // Monter la navbar
    ...
    if (mainRoot) {
        const bilanPage = new BilanCompetencesPage();
        bilanPage.render(mainRoot);
    }
